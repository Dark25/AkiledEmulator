    ...
    class LTDSorpresa : IChatCommand
    {
        public void Execute(GameClient Session, Room Room, RoomUser UserRoom, string[] Params)
        {
            ...
            AkiledEnvironment.GetGame().GetClientManager().SendMessage(new RoomNotificationComposer("¡LTD SORPRESA!",
              "¡Estimados Usuairios De <font color=\"#ff871d\"><b>© " + name_hotel + " 2020</b></font> Acaba De Ser Actualizado <b>El Catálogo!</b> Esta Vez Se Trata De Un Nuevo <font color=\"#fecb00\"><b>Rare(s) LTD Sorpresa</b></font> Sólo Debes Hacer Click En El Botón De Abajo Para Visualizarlo.<br>", ltdsorpresa_alert, Encoding.GetEncoding("Windows-1252").GetString(Encoding.GetEncoding("UTF-8").GetBytes("Ir a La Página LTD")), "event:catalog/open/rares_sorpresa" + Message));
