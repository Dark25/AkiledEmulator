...
using Akiled.HabboHotel.GameClients;using Akiled.HabboHotel.Users;
            ...
            }            if (Session.Langue != clientByUsername.Langue)
            {
                ...
                {
                     AkiledEnvironment.GetGame().GetClientManager().BanUserAsync(Session, "Robot", (double)788922000, "Su cuenta ha sido prohibida por seguridad", false, false).ConfigureAwait(false);
                }            }        }    }}