...
namespace Akiled.HabboHotel.Rooms.Chat.Commands.Cmd
{
    class CDAALERT : IChatCommand
    {
        public void Execute(GameClient Session, Room Room, RoomUser UserRoom, string[] Params)
        {
            ...
            string AlertMessage = Encoding.GetEncoding("Windows-1252").GetString(Encoding.GetEncoding("UTF-8").GetBytes("<i>¡Central de Ayuda Abierta!</i>" +
            "\r\r" +
            "El usuario <b> <font><font color=\"#58ACFA\">"
                 + Session.GetHabbo().Username + "</font></font></b> ha abierto la Central de Ayuda <b><br>Ven a resolver tus dudas sobre el hotel con nuestros <b>Guías</b> capacitados para responder casi todo tipo de preguntas, siempre y cuando no sean preguntas en bromas o chistes.<br><br><font><font color=\"#DB0003\">Si algún guía no puede resolver tu duda, acude con un supervisor para aclarar la respuesta.</font></font>"));
